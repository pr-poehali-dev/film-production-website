...
const Index = () => {
  ...
  const specialties = [
    ...
    },
    {
      ...
      image: 'https://cdn.poehali.dev/projects/21705854-61e7-49a4-9a6c-091e620449dc/files/8b9f93e6-c7ca-4965-bbcc-96256034ea9a.jpg'
    },
    {
      id: 'gaffer',
      category: 'Свет',
    ...
    },
    {
      ...
      image: 'https://cdn.poehali.dev/projects/21705854-61e7-49a4-9a6c-091e620449dc/files/f17e927f-e19e-497f-a5af-d099eeb18b9f.jpg'
    },
    {
      id: 'vfx',
      category: 'Постпродакшн',
      ...
      image: 'https://cdn.poehali.dev/projects/21705854-61e7-49a4-9a6c-091e620449dc/files/f21141e0-d8ee-40c5-8848-c1f2661afb40.jpg'
    }
  ];
  ...
  const equipment = [
    ...
    },
    {
      name: 'HMI-лампы',
      category: 'Оборудование',
      description: 'Мощные источники холодного света, имитирующие дневной свет. Используются для освещения больших пространств, создания эффекта солнца.',
      icon: 'Sun'
    },
    {
      name: 'LED-панели',
      category: 'Оборудование',
      description: 'Современные, энергоэффективные и компактные источники света, позволяющие регулировать цветовую температуру и яркость. Широко используются благодаря своей универсальности.',
      icon: 'Lamp'
    },
    {
      name: 'Флуоресцентные лампы',
      category: 'Оборудование',
      description: 'Используются для мягкого, рассеянного освещения, часто применяются для съёмки интерьеров.',
      icon: 'Lightbulb'
    },
    {
      name: 'ПО для VFX',
      category: 'Оборудование',
      description: 'Программные обеспечения для визуальных эффектов: Adobe After Effects, Foundry Nuke, Blender.',
      icon: 'Sparkles'
    },
    {
      name: 'ПО для цветокоррекции',
      category: 'Оборудование',
      description: 'Программные обеспечения для цветокоррекции: DaVinci Resolve, Adobe SpeedGrade, Baselight.',
      icon: 'Palette'
    },
    {
      name: 'Инструменты цветокоррекции',
      category: 'Оборудование',
      description: 'Специализированные панели для цветокоррекции (например, Tangent Wave/Ripple), калиброванные мониторы.',
      icon: 'Monitor'
    }
  ];
